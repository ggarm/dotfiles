...
hi Folded          guifg=#444444 guibg=#000000 gui=italic
...
hi Search          guifg=#CC1122 guibg=#121212 gui=bold
...
hi Comment         guifg=#AF875F               gui=italic
...
if &t_Co > 255 "{{{
  " Setting normal before any other highlight group is a good idea
   ...
   hi Folded          ctermfg=0  ctermbg=16    cterm=bold
   ...
   hi Search          ctermfg=9 ctermbg=232
